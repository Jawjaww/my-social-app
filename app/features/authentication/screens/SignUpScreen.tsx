...
function SignUpScreen() {
  ...
  const handleSignUp = async () => {
    if (password !== confirmPassword) {
      Toast({ message: t("auth.error.passwordMismatch"), type: "error" });
      return;
    }
    try {
  ...
  return (
    <Container>
      ...
      <Button title={t("signUp.button")} onPress={handleSignUp} disabled={isLoading} />
      <LinkText onPress={() => navigation.navigate('Auth', { screen: 'SignIn' })}>
